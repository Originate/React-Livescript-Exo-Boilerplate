(function() {
  var ConfigurationLoader, _, async, asyncHandlers, fs, path, yaml,
  ...
  ConfigurationLoader = (function() {
    ...
    ConfigurationLoader.prototype.load = function(dir, done) {
      ...
      merge = function(args) {
        return _.mergeWith.apply(_, slice.call(args).concat([customizer]));
      };
    ...
    ConfigurationLoader.prototype.loadDefaultConfig = function(done) {
      return this.loadConfig(this.defaultConfigPath, done);
    };

    ConfigurationLoader.prototype.loadUserConfig = function(dir, done) {
      var userConfigPath;
      userConfigPath = path.join(dir, 'dependency-lint.yml');
      return fs.exists(userConfigPath, (function(_this) {
        return function(exists) {
          if (!exists) {
            return done(null, {});
          }
          return _this.loadConfig(userConfigPath, done);
        };
      })(this));
    };
