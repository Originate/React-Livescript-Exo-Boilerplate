(function() {
  var ModuleNameParser, RequiredModuleFinder, _, async, detective, fs, glob, path;
  ...
  RequiredModuleFinder = (function() {
    function RequiredModuleFinder(arg) {
      this.filePattern = arg.filePattern, this.ignoreFilePatterns = arg.ignoreFilePatterns, this.stripLoaders = arg.stripLoaders, this.transpilers = arg.transpilers;
    }
    ...
    RequiredModuleFinder.prototype.compileIfNeeded = function(arg, done) {
    ...
    RequiredModuleFinder.prototype.compile = function(arg, done) {
      var compiler, content, err, error, filePath, result;
      compiler = arg.compiler, content = arg.content, filePath = arg.filePath;
      try {
